...
from sklearn.metric.RocCurveDisplay.from_predictions import  plot_roc_curve
...
path = "/Users/SalmaDkier/Desktop/Data Mining/Data Mining project/Dataset/Clean_Dataset.csv"
...
def main():
    ...
    if selected == "Algorithms":
        ...
        #     if 'Confusion Matrix' in metrics_list:
        #         st.subheader("Confusion Matrix")
        #         # Assuming you have access to the model, x_test, y_test, and class_names
        ...
        #     if 'ROC Curve' in metrics_list:
        #         st.subheader("ROC Curve")
        #         # Assuming you have access to the model and x_test
...
######################################################################
    ...
    if selected == "Home":
        ...
        image1 = Image.open('/Users/SalmaDkier/Desktop/Data Mining/Data Mining project/Images/ENSIAS.png')
    ...
    if selected == "Predict":
        with st.form("my_form"):
            ...
            if submitted:
                ...
                #model = RandomForestClassifier(n_estimators=50, max_depth=20, bootstrap=bootstrap)
